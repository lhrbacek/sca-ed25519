...
void shake256_masked(unsigned char *output1, unsigned char *output2, unsigned long long outlen, const unsigned char *input1, const unsigned char *input2, unsigned long long inlen);
